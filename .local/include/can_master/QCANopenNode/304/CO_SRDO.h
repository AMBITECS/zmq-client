...
protected:
    ...
    static void configurationValidUnset(CO_SRDOGuard_t* SRDOGuard);
    static ODR_t OD_write_dummy(OD_stream_t* stream, const void* buf, OD_size_t count, OD_size_t* countWritten);
    static ODR_t OD_read_dummy(OD_stream_t* stream, void* buf, OD_size_t count, OD_size_t* countRead);
#ifdef CO_CONFORMANCE_TEST_TOOL_ADAPTATION
    static bool_t OD_not_write_same_value(OD_stream_t* stream, const void* buf, OD_size_t count);
#endif
    static ODR_t OD_read_SRDO_communicationParam(OD_stream_t* stream, void* buf, OD_size_t count, OD_size_t* countRead);
    static ODR_t OD_write_SRDO_communicationParam(OD_stream_t* stream, const void* buf, OD_size_t count, OD_size_t* countWritten);
    static ODR_t OD_write_SRDO_mappingParam(OD_stream_t* stream, const void* buf, OD_size_t count, OD_size_t* countWritten);
    static ODR_t OD_write_13FE(OD_stream_t* stream, const void* buf, OD_size_t count, OD_size_t* countWritten);
    static ODR_t OD_write_13FF(OD_stream_t* stream, const void* buf, OD_size_t count, OD_size_t* countWritten);
