...
typedef struct {
    ...
    void (*pFunctNMT)(void *arg, CO_NMT_internalState_t state); /**< From CO_NMT_initCallbackChanged() or NULL */
    void *pFunctNMTArg;
#endif
    CO_NMT *_co_nmt_engien;
} CO_NMT_t;
...
protected:
    // uint8_t _m_nodeId;                   /**< From CO_NMT_init() */
    // uint16_t _m_NMTcontrol;              /**< From CO_NMT_init() */

protected:
    static ODR_t OD_write_1017(OD_stream_t* stream, const void* buf, OD_size_t count, OD_size_t* countWritten);
 ...
 */
void CO_NMT_initCallbackChanged(CO_NMT_t* NMT, void (*pFunctNMT)(void *, CO_NMT_internalState_t), void *pFunctNMTArg);
#endif
