...
#endif
//    CO_HBconsumer *_co_hb_consumer_engien;
} CO_HBconsNode_t;
...
typedef struct {
    ...
    /** Callback for remote NMT changed event.  From CO_HBconsumer_initCallbackNmtChanged() or NULL. */
    void (*pFunctSignalNmtChanged)(void *arg, uint8_t nodeId, uint8_t idx, CO_NMT_internalState_t NMTstate, void* object);
    void *pFunctSignalNmtChangedArg;
    void* pFunctSignalObjectNmtChanged; /**< Pointer to object */
#endif
    CO_HBconsumer *_co_hb_consumer_engien;
} CO_HBconsumer_t;
...
void CO_HBconsumer_initCallbackNmtChanged(CO_HBconsumer_t* HBcons, uint8_t idx, void* object,
                                          void (*pFunctSignal)(void *arg, uint8_t nodeId, uint8_t idx,
                                                               CO_NMT_internalState_t NMTstate, void* object), void *pFunctSignalArg);
#endif
