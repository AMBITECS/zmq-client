...
typedef struct {
    ...
    CO_CANmodule_t* CANdevRx; /**< From CO_LSSmaster_init() */
    ...
    CO_LSSmaster *_co_lss_master_engien;
...
{
public:
    CO_LSSmaster() = default;
    ~CO_LSSmaster() = default;

protected:
    static void CO_LSSmaster_receive(void* object, void* msg);
    static inline CO_LSSmaster_return_t CO_LSSmaster_check_timeout(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us);
    static CO_LSSmaster_return_t CO_LSSmaster_switchStateSelectInitiate(CO_LSSmaster_t* LSSmaster, CO_LSS_address_t* lssAddress);
    static CO_LSSmaster_return_t CO_LSSmaster_switchStateSelectWait(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us);
    static CO_LSSmaster_return_t CO_LSSmaster_inquireInitiate(CO_LSSmaster_t* LSSmaster, uint8_t cs);
    static CO_LSSmaster_return_t CO_LSSmaster_inquireCheckWait(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us, uint8_t csWait, uint32_t* value);
    static CO_LSSmaster_return_t CO_LSSmaster_configureCheckWait(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us, uint8_t csWait);
    static void CO_LSSmaster_FsSendMsg(CO_LSSmaster_t* LSSmaster, uint32_t idNumber, uint8_t bitCheck, uint8_t lssSub, uint8_t lssNext);
    static CO_LSSmaster_return_t CO_LSSmaster_FsCheckWait(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us);
    static CO_LSSmaster_return_t CO_LSSmaster_FsScanInitiate(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us, CO_LSSmaster_scantype_t scan, uint8_t lssSub);
    static CO_LSSmaster_return_t CO_LSSmaster_FsScanWait(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us, CO_LSSmaster_scantype_t scan);
    static CO_LSSmaster_return_t CO_LSSmaster_FsVerifyInitiate(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us, CO_LSSmaster_scantype_t scan,
                                                               uint32_t idNumberCheck, uint8_t lssNext);
    static CO_LSSmaster_return_t CO_LSSmaster_FsVerifyWait(CO_LSSmaster_t* LSSmaster, uint32_t timeDifference_us, CO_LSSmaster_scantype_t scan, uint32_t* idNumberRet);
    static uint8_t CO_LSSmaster_FsSearchNext(CO_LSSmaster_t* LSSmaster, const CO_LSSmaster_fastscan_t* fastscan);
