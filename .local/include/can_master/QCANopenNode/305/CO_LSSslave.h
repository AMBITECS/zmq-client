...
void CO_LSSslave_initCfgStoreCall(CO_LSSslave_t* LSSslave, void* object,
                                  bool_t (*pFunctLSScfgStore)(void* arg, void* object, uint8_t id, uint16_t bitRate), void *pFunctLSScfgStoreArg);
