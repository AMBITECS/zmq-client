...
typedef struct {
    ...
    CO_CANerror *_co_can_error_engien;
...
protected:
    static CO_CANinterfaceState_t CO_CANerrorSetListenOnly(CO_CANinterfaceErrorhandler_t* CANerrorhandler, bool_t resetIf);
    static void CO_CANerrorClearListenOnly(CO_CANinterfaceErrorhandler_t* CANerrorhandler);
    static CO_CANinterfaceState_t CO_CANerrorBusoff(CO_CANinterfaceErrorhandler_t* CANerrorhandler, const struct can_frame* msg);
    static CO_CANinterfaceState_t CO_CANerrorCrtl(CO_CANinterfaceErrorhandler_t* CANerrorhandler, const struct can_frame* msg);
    static CO_CANinterfaceState_t CO_CANerrorNoack(CO_CANinterfaceErrorhandler_t* CANerrorhandler, const struct can_frame* msg);
